...
import { IGetMedicineListPageStore, ILanguageSelectorStore, ITranslationManager, MedicineRequest } from "../../../../types";
...
export class PageSettings extends React.Component<PageSettingsProps> {
            ...
            <div id="App-page-settings">
                <div className='App-page-row-setting'>
                    <div className='row'>
                        ...
                        <label className='column' htmlFor='only-available-medicines'>{this.props.translationManager.getTranslation(this.props.languageSelectorStore.language.get(), "FORM_GET_MEDICINE_SHOW_AVAILABLE")}</label>
                    </div>
                </div>
                <div className='App-page-row-setting'>
                    <div className='row'>
                        ...
                        <label className='column' htmlFor='only-not-expired-medicines'>{this.props.translationManager.getTranslation(this.props.languageSelectorStore.language.get(), "FORM_GET_MEDICINE_SHOW_NOT_EXPIRED")}</label>
                    </div>
                </div>
                <div className='App-page-row-setting'>
                    <div className='row'>
                        <div className='column'>{this.props.translationManager.getTranslation(this.props.languageSelectorStore.language.get(), "FORM_GET_MEDICINE_PAGE")}</div>
                ...
                <div className='App-page-row-setting'>
                    <div className='row'>
                        <div className='column'>{this.props.translationManager.getTranslation(this.props.languageSelectorStore.language.get(), "FORM_GET_MEDICINE_ITEMS_PER_PAGE")}</div>
                ...
                <div className='App-page-row-setting'>
                    <div className='row'>
                        <div className='column'>{this.props.translationManager.getTranslation(this.props.languageSelectorStore.language.get(), "FORM_GET_MEDICINE_MANUFACTURER")}</div>
                ...
                <div className='App-page-row-setting'>
                    <div className='row'>
                        <div className='column'><button onClick={this.onResetRequest} disabled={this.props.store.loadingData.get()}>{this.props.translationManager.getTranslation(this.props.languageSelectorStore.language.get(), "FORM_GET_MEDICINE_RESET_REQUEST")}</button></div>
                    </div>
                </div>
                <div className='App-page-row-setting'>
                    <div className='row'>
    ...
    private renderPageCountText(showPageCount: boolean, pages: number) {
        const availablePagesText = this.props.translationManager.getTranslation(this.props.languageSelectorStore.language.get(), "FORM_GET_MEDICINE_AVAILABLE_PAGES");
        const loadingPageCountText = this.props.translationManager.getTranslation(this.props.languageSelectorStore.language.get(), "FORM_GET_MEDICINE_LOADING_PAGE_COUNT");
